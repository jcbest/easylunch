...
$sql = "SELECT users.name,users.email,users.phone,booking.food,booking.book_time,booking.time,booking.message from users inner join booking where  users.idcard=booking.idcard";
